...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Muhammad Muzamil$red◀$rset"
echo -e "$red                      ⫸$ylo  516 Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infected]$rset"
echo " "
echo " "
}
baner1(){
...
then
am start -a android.intent.action.VIEW -d https://social516.nicepage.io/ > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
...
then
am start -a android.intent.action.VIEW -d https://wa.me/+923071645948> /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
while git clone https://github.com/muzamiljamil/muzamil26 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
